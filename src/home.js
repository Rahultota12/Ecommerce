...
import mobileImage from './img/Mobile Phone.png';
import watchImage from './img/smart watch.png';
import headphoneImage from './img/headphone.png';
import cpuImage from './img/cpu heat.jpg';
  ...
  return (
    ...
    <div className='product_type'>
      <div className='container'>
        ...
        <div className='box'>
          <div className='img_box'>
            <img src={mobileImage} alt='mobile'></img>
          </div>
          <div className='detail'>
            <p>23 products</p>
          </div>
        ...
        <div className='box'>
          <div className='img_box'>
            <img src={watchImage} alt='watch'></img>
          </div>
          <div className='detail'>
            <p>18 products</p>
          </div>
